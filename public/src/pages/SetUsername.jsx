      ...
      {email && (
        ...
        <form onSubmit={(event)=>handleSubmit(event)}>
            ...
            <div className="row">
              ...
              <input type="text" name="username" placeholder="Username" onChange={e=>handleChange(e.target.value)} min="3" className={`${usernameStatus ? "success" : usernameStatus !== undefined ? "danger" : ""}`} />
              <label htmlFor='' className={`${usernameStatus ? "success" : usernameStatus !== undefined ? "danger" : ""}`}>
                {label} 
              </label>
            </div>
